      ...
      <div className="mx-auto grid max-w-7xl gap-7 lg:grid-cols-[1fr_1fr_1fr]">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            ...
            <a href="https://www.instagram.com/masterhoop" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-3 py-2 text-sm font-bold text-white/80 hover:text-brand-orange">
              <Instagram size={18} /> @masterhoop
            </a>
          </div>
          <div>
